...
define('services/security',["jquery","jquery.utilities"],function(e){function t(e,t){return v+"api/Account/ExternalLogins?returnUrl="+encodeURIComponent(e)+"&generateState="+(t?"true":"false")}function n(e,t){return v+"api/Account/ManageInfo?returnUrl="+encodeURIComponent(e)+"&generateState="+(t?"true":"false")}function r(){var e=sessionStorage.accessToken||localStorage.accessToken;return e?{Authorization:"Bearer "+e}:{}}function i(e){var t,n;if(!e||!e.message)return null;if(e.modelState)for(var r in e.modelState)n=e.modelState[r],n.length&&(t=n.join(","));return void 0===t&&(t=e.message),t}function o(t){return e.ajax(m,{type:"POST",data:t,headers:r()})}function a(t){return e.ajax(y,{type:"POST",data:t,headers:r()})}function s(n,i){return e.ajax(t(n,i),{cache:!1,headers:r()})}function l(t,i){return e.ajax(n(t,i),{cache:!1,headers:r()})}function u(t){var n;return n="undefined"!=typeof t?{Authorization:"Bearer "+t}:r(),e.ajax(N,{cache:!1,headers:n})}function c(t){return e.ajax(b,{type:"POST",data:t})}function d(){return e.ajax(w,{type:"POST",headers:r()})}function f(t){return e.ajax(x,{type:"POST",data:t})}function p(t,n){return e.ajax(k,{type:"POST",data:n,headers:{Authorization:"Bearer "+t}})}function g(t){return e.ajax(T,{type:"POST",data:t,headers:r()})}function h(t){return e.ajax(S,{type:"POST",data:t,headers:r()})}var v=e.getBasePath(),m=v+"api/Account/AddExternalLogin",y=v+"api/Account/changePassword",b=v+"Token",w=v+"api/Account/Logout",x=v+"api/Account/Register",k=v+"api/Account/RegisterExternal",T=v+"api/Account/RemoveLogin",S=v+"api/Account/setPassword",E=v,N="api/Account/UserInfo",C={addExternalLogin:o,changePassword:a,getExternalLogins:s,getManageInfo:l,getUserInfo:u,login:c,logout:d,register:f,registerExternal:p,removeLogin:g,setPassword:h,returnUrl:E,toErrorString:i};return e.ajaxPrefilter(function(t,n,r){r.failJSON=function(t){r.fail(function(n,r){var i;try{i=e.parseJSON(n.responseText)}catch(o){i=null}t(i,r,n)})}}),C});
...
define('viewmodels/browse',["durandal/app","knockout","repository/videoGameList"],function(e,t,n){return{displayName:"Browse LFG Games",features:["OWIN OAuth support (with 3rd party authentication providers)","Remember user using local storage","Secure routing","Customise views for the user dependent on user roles"],references:[{name:"Durandal",url:"http://durandaljs.com/"},{name:"Bootstrap",url:"http://getbootstrap.com/"},{name:"ASP.NET OWIN",url:"http://www.asp.net/vnext/overview/authentication"}],videoGame:t.observableArray([]),activate:function(){this.videoGame(n.listVideoGames())}}});
